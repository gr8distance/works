...
ActiveRecord::Schema.define(version: 20150705061302) do
  ...
  add_index "fees", ["staff_id"], name: "index_fees_on_staff_id"
  ...
  add_index "selections", ["staff_id"], name: "index_selections_on_staff_id"
